            ...
            <div className="adt-preview-content">
                ...
                <div className="preview-section">
                    ...
                    <div style={{ marginBottom: '2rem' }}>
                        ...
                        <div className="code-block" style={{ padding: '0.5rem 1rem' }}>
                            <PseudoCodeRenderer code={activeImplementation.domainSpace || '// No domain space defined'} />
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        {adt.profiles.map(p => (
                            <div key={p.id} style={{ marginBottom: '2rem' }}>
                                ...
                                <div className="code-block" style={{ padding: '0.5rem 1rem' }}>
                                    <PseudoCodeRenderer code={activeImplementation.methods[p.id] || `// Implementation for ${p.name} missing`} />
                                </div>
                            </div>
                        ))}
                    </div>
